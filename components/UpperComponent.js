...
export default function UpperComponent({setJSONData, textRef, displayText}) {
    ...
    <View style={styles.compView}>
        ...
        <View style={styles.cgView}>
            ...
            <View style={styles.rightCGView}>
                <TextInput onChangeText={(text)=>{context.setCallGap(text)}} style={styles.tInput} placeholder="type here..." keyboardType='numeric'/>
            </View>
        </View>
        ...
        <View style={styles.jdView}>
            ...
            {/* On change atrributes setJSONData(value); displayText() */}
            <TextInput ref={(ref)=>textRef=ref} onChangeText={(value)=>{ context.update(value) }} multiline={true} style={styles.jdInput} placeholder='type here...'/>
        </View>
    </View>
  )
}
